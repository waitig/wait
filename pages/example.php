...
<div class="demo-header">
	...
	<span style="display:none"><?php if( waitig_gopt('d_track_b') != '' ) echo waitig_gopt('d_track'); ?></span>
</div>
<div class="demo-container demo"><?php echo $theCode; ?></div>
<div style="display:none"><?php if( waitig_gopt('d_track_b') ) echo waitig_gopt('d_track'); ?></div>
</body>
</html>
