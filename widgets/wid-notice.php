<?php  
add_action( 'widgets_init', 'd_notice' );

function d_notice() {
	register_widget( 'd_notice' );
}

class d_notice extends WP_Widget {
	function d_notice() {
		$widget_ops = array( 'classname' => 'd_notice', 'description' => '显示一个公告栏' );
		$this->WP_Widget( 'd_notice', 'wait-网站公告', $widget_ops, $control_ops );
	}
