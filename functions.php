...
/*function deel_copyright($content) {
	if( !is_page() ){
		...
		$content.= '<div class="open-message" align="center"><i class="fa fa-bullhorn"></i> <p>本作品采用
<a href="http://www.waitig.com/go/licenses" rel="license">知识共享署名-非商业性使用 3.0 许可协议</a>
进行许可。</p>
<p>转载请注明：<a href="'.get_bloginfo('url').'">'.get_bloginfo('name').'</a> &raquo; <a href="'.get_permalink().'">'.get_the_title().'</a></p></div>';
	}
	return $content;
}*/
